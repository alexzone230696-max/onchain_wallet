...
// import 'package:on_chain_wallet/future/wallet/network/ton/account/state.dart';
...
//   @override
//   TonChain get account => widget.account;
//   WalletTonNetwork get network => account.network;
//   @override
//   TonClient get client => widget.client;
...
//       final jettons =
//           await widget.client.getAccountJettons(address.networkAddress);
//       return jettons;
//     });
//     if (result.hasError) {
...
//       return await widget.client.getJettonInfo(jetton);
//     });
